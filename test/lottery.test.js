...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.guita = await MockBEP20.deployed();
        ...
        await this.guita.transfer(bob, '2000', { from: minter });
        await this.guita.transfer(alice, '2000', { from: minter });
        await this.guita.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.guita.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.guita.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.guita.balanceOf(this.lotteryProxyAddress)).toString(), '418');
