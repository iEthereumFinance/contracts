...
// File: @iethereum/matrixswap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/GuitaProfile.sol
...
*/
contract GuitaProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public guitaToken;
    ...
    uint256 public numberGuitaToReactivate;
    uint256 public numberGuitaToRegister;
    uint256 public numberGuitaToUpdate;
    ...
    constructor(
        IBEP20 _guitaToken,
        uint256 _numberGuitaToReactivate,
        uint256 _numberGuitaToRegister,
        uint256 _numberGuitaToUpdate
    ) public {
        guitaToken = _guitaToken;
        numberGuitaToReactivate = _numberGuitaToReactivate;
        numberGuitaToRegister = _numberGuitaToRegister;
        numberGuitaToUpdate = _numberGuitaToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends GUITA to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer GUITA tokens to this contract
        guitaToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberGuitaToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer GUITA token to this address
        guitaToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberGuitaToUpdate
    ...
    /**
     * @dev Claim GUITA to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        guitaToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of GUITA to register
     * Callable only by owner admins.
     */
    function updateNumberGuita(
        uint256 newNumberGuitaToReactivate,
        uint256 _newNumberGuitaToRegister,
        uint256 _newNumberGuitaToUpdate
    ) external onlyOwner {
        numberGuitaToReactivate = newNumberGuitaToReactivate;
        numberGuitaToRegister = _newNumberGuitaToRegister;
        numberGuitaToUpdate = _newNumberGuitaToUpdate;
    }
